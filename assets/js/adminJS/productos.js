...
if($('#create_exento').val() > 0){
    $("#create_exento").prop('checked', true);
}
if($('#create_tec').val() > 0){
    $("#create_tec").prop('checked', true);
}
...
function resete(){
    ...
    $("#create_exento").prop('checked', false);
    $("#create_exento").val('0');
    $("#create_cnscc").prop('checked', false);
    $("#create_cnscc").val('0');
}
...
function viewProducto(num){ // funcion para llenar el modal de vista del producto
...
$(document).ready(function(){
    ...
    $('#create_perecedero').on('change', function(e){     
     ...
     //Para saber si el roducto es perecedero
     $('#create_tec').on('change', function(e){     
        if( $("#create_tec").prop('checked')){
            $('#create_tec').val('1');
        }else{
        $('#create_tec').val('0');
        }      
    });
    $('#create_exento').on('change', function(e){     
        if( $("#create_exento").prop('checked')){
            $('#create_exento').val('1');
        }else{
        $('#create_exento').val('0');
        }      
