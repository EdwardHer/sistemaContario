                                ...
                                <form action="<?php echo base_url();?>ajustes/ajustes/impuestoEdit" method='POST'>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">                                       
                                            ...
                                            <div class="col-md-4 mt-5"> 
                                                <label>Productos con IVA aplicado.</label>                     
                                                    <div class="s-swtich">                          
                                                        <input type="checkbox" id="impuesto_iva" name="impuesto_iva" class="form-check-input"  value="<?php echo $ajuste->IVA;?>">
                                                        <label for="impuesto_iva" class="form-check-label">Exento.</label>
                                                    </div>
                                            </div>
                                            <div class="col-md-4 mt-5"> 
                                                <label>Productos con impuesto de tecnología aplicado.</label>                     
                                                    <div class="s-swtich">                          
                                                        <input type="checkbox" id="impuesto_tec" name="impuesto_tec" class="form-check-input"  value="<?php echo $ajuste->TEC;?>">
                                                        <label for="impuesto_tec" class="form-check-label">Exento.</label>
                                                    </div>
                                            </div>
                                        </div>    
