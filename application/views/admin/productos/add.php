                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <div class="input-group mt-4">                                  
                                        ...
                                        <label>Producto exento.</label>                     
                                            <div class="s-swtich">                          
                                                <input type="checkbox" id="create_exento" name="create_exento" class="form-check-input">
                                        ...
                                        <label>Imouesto de tecnología.</label>                     
                                            <div class="s-swtich">                          
                                                <input type="checkbox" id="create_tec" name="create_tec" class="form-check-input">
