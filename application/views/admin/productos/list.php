                                                        ...
                                                        <?php $cont++;?>
                                                            ...
                                                            <?php } ?>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    .$pro->marca."*".$pro->stock_actual."*".$pro->valor."*".$pro->compra."*".$pro->venta.'*'.$pro->exento.'*'.$pro->TEC; ?> 
                        ...
                        <div class="col-md-9 mt-4">
                            <div class="input-group">
                                ...
                                <div class="col-md-3"> 
                                    <label>Exento</label>                     
                                    <div class="s-swtich">                          
                                        <input type="checkbox" id="create_exento"  class="form-check-input" disabled>
                                        <label for="create_exento" class="form-check-label">Perecedero.</label>
                                    </div>
                                </div>          
                                <div class="col-md-3"> 
                                    <label>Impuesto TEC.</label>                     
                                    <div class="s-swtich">                          
                                        <input type="checkbox" id="create_tec"  class="form-check-input" disabled>
                                        <label for="create_tec" class="form-check-label">Perecedero.</label>
                                    </div>
                                </div>           
                            </div> 
                        </div>                       
