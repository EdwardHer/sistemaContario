...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-01-2020 a las 02:36:20
...
CREATE TABLE IF NOT EXISTS `ajustes` (
  ...
  `IVA` tinyint(4) NOT NULL DEFAULT '1',
  `TEC` tinyint(4) NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`)
...
INSERT INTO `ajustes` (`id`, `nombre`, `direccion`, `registro`, `giro`, `logo`, `telefono`, `correo`, `codigo`, `IVA`, `TEC`) VALUES
(1, 'Bazar Zulma', 'San Miguel', '138513-0', 'venta de ropa', 'photo4906976604010424386.jpg', '6109-9440', 'holak@hace.com', 0, 1, 1);
...
INSERT INTO `comprobantes` (`id_comprobante`, `nombre`) VALUES
(1, 'Factura'),
(2, 'Ticket'),
(3, 'Cotización'),
(4, 'Crédito fiscal');
...
(20, 4, 48, 1, 4, 19, 33, 1),
(21, 8, 49, 1, 8, 20, 34, 1),
(22, 1000, 49, 1, 1000, 21, 34, 1),
(23, 11, 49, 1.07, 11.77, 22, 34, 1);
...
CREATE TABLE IF NOT EXISTS `detalle_salida` (
  ...
  `gravada` double NOT NULL DEFAULT '0',
  `cesc` double NOT NULL DEFAULT '0',
...
INSERT INTO `detalle_salida` (`id_detalle_salida`, `cantidad`, `id_producto`, `precio_venta`, `subtotal`, `exento`, `gravada`, `cesc`, `id_salida`, `id_lote`, `id_presentacion_producto`, `estado`) VALUES
(1, 10, 43, 13.45, 134.5, 0, 0, 0, 2, 2, 29, 1),
(2, 10, 43, 13.45, 134.5, 0, 0, 0, 3, 2, 29, 1),
(3, 1, 43, 13.45, 13.45, 0, 0, 0, 4, 2, 29, 1),
(4, 4, 43, 13.45, 53.8, 0, 0, 0, 5, 2, 29, 1),
(5, 10, 43, 13.45, 134.5, 0, 0, 0, 5, 3, 29, 1),
(6, 15, 43, 13.45, 201.75, 0, 0, 0, 6, 1, 29, 1),
(7, 1, 53, 1, 1, 0, 0, 0, 7, 0, 39, 1),
(8, 1, 49, 1, 1, 0, 0, 0, 8, 0, 34, 1),
(9, 1, 49, 1, 1, 0, 0, 0, 9, 0, 34, 1),
(10, 1, 49, 1, 1, 0, 0, 0, 10, 0, 34, 1),
(11, 1, 49, 1, 1, 0, 0, 0, 11, 0, 34, 1),
(12, 1, 49, 1, 1, 0, 0, 0, 12, 0, 34, 1),
(13, 1, 49, 1, 1, 0, 0, 0, 13, 0, 34, 1),
(14, 1, 49, 1, 1, 0, 0, 0, 14, 0, 34, 1),
(15, 1, 49, 1, 1, 0, 0, 0, 15, 0, 34, 1),
(16, 1, 49, 1, 1, 0, 0, 0, 16, 0, 34, 1),
(17, 1, 49, 1, 1, 0, 0, 0, 17, 0, 34, 1),
(18, 1, 49, 1, 1, 0, 0, 0, 18, 0, 34, 1),
(19, 1, 49, 1, 1, 0, 0, 0, 19, 0, 34, 1),
(20, 1, 49, 1, 1, 0, 0, 0, 20, 0, 34, 1),
(21, 1, 49, 1, 1, 0, 0, 0, 21, 0, 34, 1),
(22, 1, 49, 1, 1, 0, 0, 0, 22, 0, 34, 1),
(23, 1, 49, 1, 1, 0, 0, 0, 23, 0, 34, 1),
(24, 1, 49, 1, 1, 0, 0, 0, 24, 0, 34, 1),
(25, 1, 49, 1, 1, 0, 0, 0, 25, 0, 34, 1),
(26, 1, 49, 1, 1, 0, 0, 0, 26, 0, 34, 1),
(27, 1, 49, 1, 1, 0, 0, 0, 27, 0, 34, 1),
(28, 1, 49, 1, 1, 0, 0, 0, 28, 0, 34, 1),
(29, 1, 50, 500, 500, 0, 0, 0, 29, 0, 35, 1),
(30, 1, 49, 1, 1, 0, 0, 0, 30, 0, 34, 1),
(31, 1, 49, 1, 1, 0, 0, 0, 31, 0, 34, 1),
(32, 1, 49, 1, 1, 0, 0, 0, 32, 0, 34, 1),
(33, 1, 49, 1, 1, 0, 0, 0, 33, 0, 34, 1);
...
(21, 1, 1, '2020-01-08', 1000, 2, 1),
(22, 1, 1, '2020-01-12', 11.77, 2, 1);
...
CREATE TABLE IF NOT EXISTS `impuestos` (
  `id_impuesto` int(5) NOT NULL AUTO_INCREMENT,
  `nombre` varchar(50) COLLATE utf8_spanish2_ci NOT NULL,
...
INSERT INTO `impuestos` (`id_impuesto`, `nombre`, `porcentaje`, `estado`) VALUES
(1, 'IMPUESTO DE TECNOLOGÍA', '10', 1),
(2, 'IVA', '13', 1);
...
(69, 1, '2020-01-08', 'Compra de producto.', 49, 1000, 1, 1000, 21, 0, 34, 1),
(70, 1, '2020-01-12', 'Compra de producto.', 49, 11, 1.07, 11.77, 22, 0, 34, 1),
(71, 2, '2020-01-16', 'Salida', 53, 1, 1, 1, 0, 7, 39, 1),
(72, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 8, 34, 1),
(73, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 9, 34, 1),
(74, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 10, 34, 1),
(75, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 11, 34, 1),
(76, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 12, 34, 1),
(77, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 13, 34, 1),
(78, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 14, 34, 1),
(79, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 15, 34, 1),
(80, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 16, 34, 1),
(81, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 17, 34, 1),
(82, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 18, 34, 1),
(83, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 19, 34, 1),
(84, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 20, 34, 1),
(85, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 21, 34, 1),
(86, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 22, 34, 1),
(87, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 23, 34, 1),
(88, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 24, 34, 1),
(89, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 25, 34, 1),
(90, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 26, 34, 1),
(91, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 27, 34, 1),
(92, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 28, 34, 1),
(93, 2, '2020-01-22', 'Salida', 50, 1, 500, 500, 0, 29, 35, 1),
(94, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 30, 34, 1),
(95, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 31, 34, 1),
(96, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 32, 34, 1),
(97, 2, '2020-01-22', 'Salida', 49, 1, 1, 1, 0, 33, 34, 1);
...
CREATE TABLE IF NOT EXISTS `lotes` (
  ...
  PRIMARY KEY (`id_lote`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf32 COLLATE=utf32_spanish2_ci AUTO_INCREMENT=4 ;
...
(14, 'Impuestos', 'mantenimiento/impuestos');
...
(39, 4, 53, 1, 0.01, 1, '000100010009', 1, 1);
...
INSERT INTO `productos` (`id_producto`, `id_categoria`, `id_stock`, `nombre`, `descripcion`, `imagen`, `perecedero`, `estado`, `id_marca`, `exento`, `TEC`) VALUES
(42, 4, 58, 'calculadora', 'calculadora casio', '', 0, 0, 4, 0, 0),
(43, 1, 59, 'Mozzarella', '', 'mozzarella.jpg', 1, 0, 1, 0, 0),
(44, 1, 60, 'ejemplo', 'asd', 'colochita_duda.jpg', 0, 0, 1, 0, 0),
(45, 1, 61, 'ejemplo', 'asd', 'colochita_duda.jpg', 0, 0, 1, 0, 0),
(46, 1, 62, 'asdas', '', NULL, 0, 1, 1, 0, 0),
(47, 1, 63, 'ejemplo 9', '', NULL, 0, 0, 1, 0, 0),
(48, 1, 64, 'ejemplo', 'asdasd', NULL, 0, 0, 1, 0, 0),
(49, 1, 65, 'prueba numero 6', 'prueba numero 6', NULL, 0, 1, 1, 0, 0),
(50, 1, 66, 'prueba numero 110', 'esta es una prueba para konny', NULL, 0, 1, 1, 0, 0),
(51, 5, 67, 'resma', 'resam', NULL, 0, 1, 4, 0, 0),
(52, 5, 68, 'fardito de papel bond', '', NULL, 0, 1, 4, 0, 0),
(53, 1, 69, 'dos punto cero ', 'mmm', NULL, 0, 1, 1, 0, 1);
...
(7, 1, 1, '2020-01-16', 1, 'venta de producto', 2, 1),
(8, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(9, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(10, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(11, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(12, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(13, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(14, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(15, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(16, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(17, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(18, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(19, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(20, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(21, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(22, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(23, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(24, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(25, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(26, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(27, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(28, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(29, 1, 1, '2020-01-22', 500, 'venta de producto', 2, 1),
(30, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(31, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(32, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1),
(33, 1, 1, '2020-01-22', 1, 'venta de producto', 2, 1);
...
CREATE TABLE IF NOT EXISTS `series` (
  ...
  `correlativo` int(9) NOT NULL DEFAULT '0',
...
INSERT INTO `series` (`id_serie`, `id_comprobante`, `serie`, `correlativo`) VALUES
(1, 1, 1, 0),
(2, 1, 1, 0),
(3, 2, 1, 5);
